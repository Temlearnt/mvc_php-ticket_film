    ...
    <div class="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        <form method="POST">
            <div class="mb-4">
                ...
                <input class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" name="name" placeholder="Enter your name" type="text" />
            ...
            <div class="mb-6">
                ...
                <input class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" maxlength="6" name="password" placeholder="Enter your password" type="password" />
                <div class="text-red-500 mb-4">
        ...
        <p class="text-center text-gray-600 mt-6">
            ...
            <a class="text-blue-600 hover:text-blue-800" href="<?=BASEURL?>auth/login">
                Sign in
            </a>
        </p>
    </div>
